...
import static com.romone183.capacitor.printer.PrintContent.ContentType.UNSUPPORTED;
...
class PrintManager {
     ...
     */
    public PrintManager(@NonNull Context context) {
     ...
     * @param callback The function to invoke once the job is done.
     */
    private void printHtml(@Nullable String content, @NonNull JSONObject settings,
            @NonNull OnPrintFinishCallback callback) {
     ...
     * @param callback The function to invoke once the job is done.
     */
    private void printText(@Nullable String content, @NonNull JSONObject settings,
            @NonNull OnPrintFinishCallback callback) {
     ...
     * @param callback The function to invoke once the job is done.
     */
    private void printContent(@Nullable String content, @NonNull String mimeType, @NonNull JSONObject settings,
            @NonNull OnPrintFinishCallback callback) {
     ...
     * @param callback The function to invoke once the job is done.
     */
    private void printWebView(@NonNull WebView view, @NonNull JSONObject settings,
            @NonNull OnPrintFinishCallback callback) {
     ...
     * @param callback The function to invoke once the job is done.
     */
    private void printPdf(@NonNull String path, @NonNull JSONObject settings, @NonNull OnPrintFinishCallback callback) {
     ...
     */
    private void printAdapter(@NonNull PrintDocumentAdapter adapter, @NonNull PrintOptions options) {
        String jobName = options.getJobName();
